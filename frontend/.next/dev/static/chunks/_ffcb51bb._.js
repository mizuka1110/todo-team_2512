    ...
    if ($[1] !== email || $[2] !== password || $[3] !== router) {
        t0 = ({
            "LoginPage[handleLogin]": async ()=>{
                ;
                try {
                    await signInWithEmailAndPassword(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], email, password);
                    router.push("/dashboard");
                } catch (t1) {
                    alert("\u30ED\u30B0\u30A4\u30F3\u306B\u5931\u6557\u3057\u307E\u3057\u305F");
                }
...
//# sourceMappingURL=_ffcb51bb._.js.map