...
"[project]/src/lib/firebase.ts [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function useAuth() {
    ...
    if ($[0] !== "96129cd7d4e795c0e2840914e5d48d938aa69852ab4f516de85e3330d5ee7e01") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "96129cd7d4e795c0e2840914e5d48d938aa69852ab4f516de85e3330d5ee7e01";
    }
        ...
        t0 = ({
            "useAuth[useEffect()]": ()=>{
                const unsubscribe = onAuthStateChanged(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                    "useAuth[useEffect() > onAuthStateChanged()]": (firebaseUser)=>{
                        setUser(firebaseUser);
                        setLoading(false);
                    }
                }["useAuth[useEffect() > onAuthStateChanged()]"]);
                return ()=>unsubscribe();
            }
        })["useAuth[useEffect()]"];
        t1 = [];
...
const API_BASE = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:3001";
const apiClient = {
...
;
const fetchTasks = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/tasks");
const createTask = (title)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/tasks", {
        title
    });
const toggleTask = (id, isDone)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].patch(`/tasks/${id}`, {
        isDone
    });
const deleteTask = (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].delete(`/tasks/${id}`);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function useTasks() {
    ...
    if ($[0] !== "2f86e1e9ffad041b347f6e87bc1cfa12b9dedc5da722be89c8f1b0c99fa252b8") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2f86e1e9ffad041b347f6e87bc1cfa12b9dedc5da722be89c8f1b0c99fa252b8";
    }
    const { data, mutate } = useSWR("/tasks", __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$taskService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTasks"]);
    let t0;
    if ($[1] !== data || $[2] !== mutate) {
        t0 = async function addTask(title) {
            const newTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$taskService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTask"](title);
            mutate([
                ...data ?? [],
                newTask
            ], false);
    ...
    let t1;
    if ($[4] !== data || $[5] !== mutate) {
        t1 = async function toggleTask(task) {
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$taskService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleTask"](task.id, !task.isDone);
            mutate(data?.map({
                "useTasks[toggleTask > (anonymous)()]": (t)=>t.id === task.id ? updated : t
            }["useTasks[toggleTask > (anonymous)()]"]), false);
        };
        $[4] = data;
        $[5] = mutate;
        $[6] = t1;
    ...
    let t2;
    if ($[7] !== data || $[8] !== mutate) {
        t2 = async function deleteTask(id) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$taskService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteTask"](id);
            mutate(data?.filter({
                "useTasks[deleteTask > (anonymous)()]": (t_0)=>t_0.id !== id
            }["useTasks[deleteTask > (anonymous)()]"]), false);
        };
        $[7] = data;
        $[8] = mutate;
        $[9] = t2;
    ...
    let t4;
    if ($[12] !== addTask || $[13] !== deleteTask || $[14] !== t3 || $[15] !== toggleTask) {
        t4 = {
            tasks: t3,
            addTask,
            toggleTask,
...
_s(useTasks, "mnOUAjni6kidF2D7fl9v1y3Ei3U=", false, function() {
    return [
        useSWR
    ];
});
...
function TaskForm(t0) {
    ...
    if ($[0] !== "a180faafe440cb2c17bbc9c6f2bbf09eb6f8780e9bf1bfe8a916920e75ee07de") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a180faafe440cb2c17bbc9c6f2bbf09eb6f8780e9bf1bfe8a916920e75ee07de";
    }
    const { onAdd } = t0;
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "TaskForm[<input>.onChange]": (e)=>setTitle(e.target.value)
...
function TaskItem(t0) {
    ...
    if ($[0] !== "f07f4066456a01537d13a9903b706ec6af85bf199ad62d1a80ac4a82913dcf43") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f07f4066456a01537d13a9903b706ec6af85bf199ad62d1a80ac4a82913dcf43";
    }
    const { task, onToggle, onDelete } = t0;
    let t1;
    if ($[1] !== onToggle || $[2] !== task.isDone) {
    ...
    const t2 = "flex-1 " + (task.isDone ? "line-through text-gray-500" : "");
    let t3;
    if ($[4] !== t2 || $[5] !== task.title) {
...
;
;
function TaskList(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(10);
    if ($[0] !== "a1b0907ff6014f79348cceea85507dc84c06f7d9554ebcb974f21697cdaa3f5e") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a1b0907ff6014f79348cceea85507dc84c06f7d9554ebcb974f21697cdaa3f5e";
    }
    const { tasks, onToggle, onDelete } = t0;
    let t1;
    if ($[1] !== onDelete || $[2] !== onToggle || $[3] !== tasks) {
        let t2;
        if ($[5] !== onDelete || $[6] !== onToggle) {
            t2 = ({
                "TaskList[tasks.map()]": (task)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TaskItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        task: task,
                        onToggle: {
                            "TaskList[tasks.map() > <TaskItem>.onToggle]": ()=>onToggle(task)
                        }["TaskList[tasks.map() > <TaskItem>.onToggle]"],
                        onDelete: {
                            "TaskList[tasks.map() > <TaskItem>.onDelete]": ()=>onDelete(task.id)
                        }["TaskList[tasks.map() > <TaskItem>.onDelete]"]
                    }, task.id, false, {
...
function DashboardPage() {
    ...
    const { tasks, addTask, toggleTask, deleteTask } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTasks"])();
...
_s(DashboardPage, "zJ/St8+TzbJxEkDjbjac8C8JBMI=", false, function() {
    return [
...
//# sourceMappingURL=_88084a58._.js.map